...
namespace Microsoft.CodeAnalysis.Diagnostics
{
	public sealed class DiagnosticDescriptor : IEquatable<DiagnosticDescriptor?>
	{
		...
		public DiagnosticDescriptor(
			...
			string? helpLinkUri = null,
			params string[] customTags)
			: this(id, title.ToString(), messageFormat.ToString(), category, defaultSeverity, isEnabledByDefault, description?.ToString(), helpLinkUri, customTags)
		{
		}
		...
		public ReportDiagnostic GetEffectiveSeverity(CompilationOptions compilationOptions) => ReportDiagnostic.Error;
